 ...
 */
 ...
 // Update Argos.io 2013-05-03 line 765: also include any amazonHeaders specified in the options as part of the request to sign.
...
Client.prototype.signedUrl = function(filename, expiration, options){
  ...
  var signature = auth.signQuery({
      amazonHeaders: (options && options.amazonHeaders) // include any amazon specific headers in the query to be signed
    , secret: this.secret
    , date: epoch
    , resource: resource
